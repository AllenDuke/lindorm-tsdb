...
public class MtTSDBEngineImpl extends TSDBEngine {
    ...
    private static final AtomicLongFieldUpdater<MtTSDBEngineImpl> FREE_SIZE_UPDATER = AtomicLongFieldUpdater.newUpdater(MtTSDBEngineImpl.class, "freeSize");
     ...
     */
    public MtTSDBEngineImpl(File dataPath) {
        super(dataPath);
        schedule();
        consume();
    }
